    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p align="center"><img src="images/Login1.jpg" width="204" height="148" /></p>
          <div class="clr"></div>
          <form id="form1" name="form1" method="post" action="UserAuthentication.jsp">
            <table width="447" border="0" align="center" cellpadding="2" cellspacing="2">
              <tr>
                <td width="240" height="62" align="center"><div align="center" class="style19">User Name (Required)</div></td>
