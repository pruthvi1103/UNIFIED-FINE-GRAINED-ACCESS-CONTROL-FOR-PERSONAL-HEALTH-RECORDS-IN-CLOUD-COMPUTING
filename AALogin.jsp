...
<div class="main">
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="UserLogin.jsp"><strong>Attribute Authority </strong></a></li>
        </ul>
      </div>
      <div class="clr"></div>
    </div>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style18">Welcome To Attribute Authority Login..</span></h2>
          <p align="center"><img src="images/Login1.jpg" width="192" height="146" /></p>
          <div class="clr"></div>
          <form id="form1" name="form1" method="post" action="AAAuthentication.jsp">
            <table width="447" border="0" align="center" cellpadding="2" cellspacing="2">
              <tr>
                <td width="240" height="62" align="center" bgcolor="#FF0000"><div align="center" class="style22">AA Name (Required)</div></td>
                <td width="261"><input id="name" name="userid" class="text" /></td>
              </tr>
              <tr>
                <td height="46" align="center" bgcolor="#FF0000"><div align="center" class="style22">Password (Required)</div></td>
