...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style23"><span class="style24">Welcome Attrubite Authority</span></span></h2>
          <div class="clr"></div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          <h2 class="star"><span>AA</span> Menu</h2>
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="UserMain.jsp">Home</a></li>
            <li><a href="A_ProvidePermission.jsp">Provide Attribute Access Permission</a></li>
