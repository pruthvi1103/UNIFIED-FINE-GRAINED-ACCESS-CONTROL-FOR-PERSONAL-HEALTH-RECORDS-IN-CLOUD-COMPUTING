...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style18"><span class="style12"><span class="style92">Patient <span class="style18"><%=request.getParameter("patient")%></span>'s Record After Publish..</span></span></span></h2>
          <div class="clr"></div>
...
<%@ page import="java.util.Random,java.io.PrintStream, java.io.FileOutputStream, java.io.FileInputStream, java.security.DigestInputStream, java.math.BigInteger, java.security.MessageDigest, java.io.BufferedInputStream" %>
          ...
          <table width="717" border="0" cellspacing="2" cellpadding="2">
            <tr>
              <td width="709"><div align="right"><a href="A_AfterPublish.jsp" class="style85 style93">Back</a></div></td>
            </tr>
          </table>
