...
<head>
<title>Verify Patients Details..</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style18"><span class="style12"><span class="style92"> Verify Patients Details Using Original Copy..</span></span></span></h2>
          <div class="clr"></div>
          <table width="901" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
            ...
            <tr>
              ...
              <td width="105" rowspan="1" align="center" valign="middle" bgcolor="#FFFFFF" ><div align="center" class="style90 style56">
                <%out.println(s1);%>
              </div></td>
              ...
              <td height="52" align="center"  valign="middle"><form action="DO_VerificationStatus.jsp" method="post">
