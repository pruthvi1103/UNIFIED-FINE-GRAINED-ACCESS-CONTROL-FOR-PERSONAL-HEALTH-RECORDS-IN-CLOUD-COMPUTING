...
<head>
<title>Data Patients Registration Page..</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style43">Welcome To Patients Registration..</span></h2>
          <p><img src="images/Register.png" width="300" height="163" /></p>
          <div class="clr"></div>
          <form action="OwnerRegisterAuthentication.jsp" method="post" id="" enctype="multipart/form-data">
