...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style18">Welcome To Data Owner Login..</span></h2>
          <p>&nbsp;</p>
          <p align="center"><img src="images/Login1.jpg" width="221" height="162" /></p>
          <div class="clr"></div>
          <form id="form1" name="form1" method="post" action="OwnerAuthentication.jsp">
            <table width="447" border="0" align="center" cellpadding="2" cellspacing="2">
              <tr>
                <td width="240" height="62" align="center"><div align="center" class="style19">Owner Name (Required)</div></td>
