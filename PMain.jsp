      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="PAssign_Policy.jsp">Assign Policy</a> </li>
