...
<%
          ...
          <table width="664" cellspacing="2" cellpadding="2">
			...
			<form action="attackerupdate.jsp" method="post">
            ...
            <tr>
              <td height="46" valign="top"><label> </label>
                <label><br />
                </label></td>
              <td> <table width="523" border="0" cellspacing="2" cellpadding="2">
                <tr>
                  <td width="298">
                      ...
                      <div align="right">
                        ...
                        <input type="submit" name="button" value="Attack" style="width:100px;height:40px;background-color:red;"/>
                      </div>
	        </form></td>
          ...
          <table width="717" border="0" cellspacing="2" cellpadding="2">
            <tr>
              <td width="709"><div align="right"><a href="attacker.jsp" class="style85 style93">Back</a></div></td>
            </tr>
          </table>
      </div>
      </div>
