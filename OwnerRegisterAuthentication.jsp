...
<head>
<title>Patients  Registration Status..</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style50">Patients  Registration Status..</span></h2>
          <div class="clr"></div>
          <div>
            <label for="name">
...
PreparedStatement ps=connection.prepareStatement("insert into owner(username,password,email,mobile,address,dob,gender,status,image) values(?,?,?,?,?,?,?,?,?)");
